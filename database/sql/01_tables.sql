...
-- Salas de proyección con grilla de asientos
CREATE TABLE SALA (
...
-- Asientos individuales por sala
...
-- Proyección programada: película, sala y horario
...
-- Reserva de entradas por usuario y función
...
-- Detalle de asientos asignados a cada reserva
...
-- Pago simulado asociado a una reserva
CREATE TABLE PAGO (
...
-- Historial de cambios de estado en reservas
